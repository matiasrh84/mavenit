...
import Constantes.NombresDialogos;
import static Constantes.NombresDialogos.CREAR_TP;
...
public class TrabajosPracticos extends javax.swing.JDialog {

    Fecha fecha = new Fecha();
    public static int idasignaturas, idprofesores, idcursos, idcuatrimestre, idperiodolectivo;
   
    public TrabajosPracticos(java.awt.Frame parent, boolean modal) {
        super(parent, CREAR_TP,modal);
        initComponents();
 ...
 void cargarcbocarrera() {
  ...
  void cargardatostp(){
      ...
      ConexionMySQL mysql = new ConexionMySQL();
        Connection cn = mysql.Conectar();
        String sSQL = "SELECT * FROM vista_datosTP WHERE Materia = '" + cbomaterias.getSelectedItem().toString() + "' AND Curso = '" + cbocursos.getSelectedItem().toString() + "' AND Cuatrimestre = '"+cbocuatrimestre.getSelectedItem().toString()+"'";
        try {
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(sSQL);
            while (rs.next()) {
                idasignaturas = rs.getInt(1);
                idprofesores = rs.getInt(2);
                idcursos = rs.getInt(3);
                idperiodolectivo = rs.getInt(4);
                idcuatrimestre = rs.getInt(5);
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Error en la base de datos...");
            JOptionPane.showMessageDialog(null, ex);
    ...
    private void initComponents() {
        ...
        cbocuatrimestre = new javax.swing.JComboBox<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Crear"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbocarreras, 0, 213, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Fecha de asignación"));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Fecha de presentación"));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbocursos, 0, 97, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Materias"));
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbomaterias, 0, 213, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Trabajos Prácticos"));
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Cuatrimestre"));

        cbocuatrimestre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PRIMER", "SEGUNDO" }));
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbocuatrimestre, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(cbocuatrimestre, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private javax.swing.JComboBox<String> cbocuatrimestre;
